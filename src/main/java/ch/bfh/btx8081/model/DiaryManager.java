...
//		this.newPatient(firstName, lastName, phoneNumber, eMail, userName, password, addiction, mainInfo, doctor, consumedSubstance, consumptionMetric, conditionAutomaticAlarm);
			...
			this.newEntry(LocalDate.of(2020, 06, 07), julian, Integer.toUnsignedLong(0), 4, 3,
					julian.getDiary().getActivities(), "Guter Tag, voll motiviert!", "Question1");
			this.newEntry(LocalDate.of(2020, 06, 06), julian, Integer.toUnsignedLong(1), 3, 2,
					julian.getDiary().getActivities(), "Schlechter Tag, viel stress bei der Arbeit", "Question2");
			this.newEntry(LocalDate.of(2020, 06, 05), julian, Integer.toUnsignedLong(2), 5, 1,
			...
			this.newEntry(LocalDate.of(2020, 05, 30), julian, Integer.toUnsignedLong(0), 2, 3,
					julian.getDiary().getActivities(), "Bla", "Warum?");
			this.newEntry(LocalDate.of(2020, 05, 29), julian, Integer.toUnsignedLong(0), 3, 3,
			...
			this.newEntry(LocalDate.of(2020, 05, 29), natalya, Integer.toUnsignedLong(0), 1, 9,
					natalya.getDiary().getActivities(), "Bla", "");
